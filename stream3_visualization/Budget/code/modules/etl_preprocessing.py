...
def load_ipcc_regions():
    ...
    regions = pd.read_excel(f"{DATA_DIR}/{iso_country_code}",
...
def load_eu_g20_mapping():
    ...
    mapping = pd.read_excel(f"{DATA_DIR}/{iso_country_code}",
...
def load_historical_population_data():
    ...
    emissions = pd.read_excel(f"{DATA_DIR}/{co2_emission_territory}",
...
def load_forecasted_population_data():
    ...
    pop = pd.read_excel(f"{DATA_DIR}/{population_timeline}",
...
def load_consumption_emissions_data():
    ...
    cons_emissions = pd.read_excel(f"{DATA_DIR}/{co2_emission_consumption}",
                                 sheet_name="GCB2024v17_MtCO2_flat")
